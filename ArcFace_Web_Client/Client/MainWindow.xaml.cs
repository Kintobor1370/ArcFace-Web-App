...
namespace WpfApp1
{
    //____________________________________________________________LISTBOX ITEM_____________________________________________________________
    public class ListItem
    {
        private string path;        // file's absolute path
    ...
    //__________________________________________________VIEWMODEL CLASS (WPF APP DATA)_____________________________________________________
    public class ViewModel : INotifyPropertyChanged
    {
        ...
        //........................Distance value between two selected images
        ...
        //.........................Similarity rate between two selected images
        ...
        //.........................Ability to start calculations (disabled if calculations for two specific images have recently finised)
        ...
        //.........................Ability to cancel the ongoing calculations (disabled if there are no ongoing calculations)
        ...
        //.........................Indeicator that the storage is not empty (Otherwise deleting all images from storage will be disabled)
        ...
        //.........................Observable Collection of names and paths of images from selected folder (used to display via ListBox)
        public ObservableCollection<ListItem> Files 
        { 
            get;
            set;
        }
        //.........................Observable Collection of names of images from storage (used to display the names via ListBox)
        public ObservableCollection<Database.Image> Images 
        { 
            get; 
            set; 
        }
    ...
    //_____________________________________________________APPLICATION'S MAIN WINDOW_______________________________________________________
    public partial class MainWindow : Window
    {
        ...
        private string DistanceTokenKey;                // Cancellation token for distance calculation
        private string SimilarityTokenKey;              // Cancellation token for similarity calculation
        ...
        //.........................Update Observable Collection of stored images
        ...
        //.........................Indicators that selection of ListBox items has been changed
        ...
        //.........................Search and open the selected images folder
        ...
        //.........................Add JPG and PNG images from selected images folder to according collections
        ...
        //.........................Addressing the server: GET /images/id
        ...
        //.........................Addressing the server: DELETE /images
        ...
        {
            // If images folder is not selected
            if (ViewModel.Files.Count == 0)
            {
                System.Windows.MessageBox.Show(
                    "Please select images folder",
                    "Images folder not detected",
                    MessageBoxButton.OK,
                    MessageBoxImage.Error
                );
                return false;
            }
            // If neither images are selected
            ...
            // If the first image is not selected
            ...
            // If the second image is not selected
            ...
            // If loading images from storage is in progress
        ...
        //.........................Calculate distance and similarity for selected images
        private async void Start_Calculations_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (ViewModel.ImagesChanged && CheckSelectedImages())
            {
                ...
                // Calculate Embedding vectors of selected images and add them to storage (if they're not present there)
                int ID1 = await PostImage(ViewModel.Image1);
                int ID2 = await PostImage(ViewModel.Image2);
                pbStatus.Value += 10;

                // Convert Embedding vectors of selected images to Task<float[]>
                ...
                // Start asynchronous calculations for distance and similarity
        ...
        //.........................Cancel ongoing calculations for selected images
    ...
    //____________________________________________________________CONVERTERS_______________________________________________________________
